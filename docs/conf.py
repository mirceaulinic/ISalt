# -*- coding: utf-8 -*-
#
# isalt documentation build configuration file, created by
...
man_pages = [(master_doc, 'isalt', u'ISalt Documentation', [author], 1)]
